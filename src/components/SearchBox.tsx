      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full">
        <div className="flex-1 relative">
          <button
            ...
            `}
          >
            <span className={`text-lg ${selectedDescription ? 'text-gray-900' : 'text-gray-500'} break-words whitespace-pre-line w-full`}
        ...
        <button
          ...
          className={`
            px-6 py-4 rounded-xl font-medium w-full sm:w-auto
            transition-all duration-200 ease-in-out flex items-center gap-2 justify-center
